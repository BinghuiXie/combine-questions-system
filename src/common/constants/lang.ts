export const INPUT_PHONE_ID: string = 'input_phone_id';
export const INPUT_PASSWPRD: string = 'input_password';
export const ADMINISTRATOR_LOGIN: string = 'administrator_login';
...
export const CHANGE_NOW: string = 'change_now';
...
export const BATCH_DELETE: string = 'batch_delete';
